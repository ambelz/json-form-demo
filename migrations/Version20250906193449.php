 ...
 */
final class Version20250906193449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE form_schema (id VARCHAR(36) NOT NULL, json_structure CLOB NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, last_accessed_at DATETIME DEFAULT NULL, access_count INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY (id))');
